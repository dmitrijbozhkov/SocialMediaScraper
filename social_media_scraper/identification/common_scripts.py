...
function setDone() {
    ...
    let choosePrompt = document.querySelector("#choose-prompt");
    if (choosePrompt) {
...
def build_script(selector: str) -> str:
    """ Makes script, that manages search results """
    return r"""
    """+ SCRIPT_FUNCTIONS + r"""
